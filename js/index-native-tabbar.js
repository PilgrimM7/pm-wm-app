var util = {
	...
	updateSubNView: function(currIndex, color) {
	    ...
	    var nviewObj = plus.nativeObj.View.getViewById("tabBar"); // 获取nview控件对象
		var currTag = nviewObj.tags[currIndex]; // 获取当前需重绘的tag

		nviewObj.drawText(currTag.text, currTag.position, util.changeColor(currTag.textStyles, color), currTag.id);
	}
};